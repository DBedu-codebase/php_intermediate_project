...
<body>
    <nav class="pt-20 flex flex-col items-center dark:bg-gray-900" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li class="inline-flex items-center">
                <a href="/api/v1/book" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
    ...
    <section class="bg-white dark:bg-gray-900 h-screen">
        <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
            ...
            <form action="/api/v1/book/update/<?= $book["id"] ?>" method="post">
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            value="<?= htmlspecialchars($book["title"]) ?>" placeholder="Type book name" required="">
                    </div>
                    <div class="w-full">
