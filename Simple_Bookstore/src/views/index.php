...
<body>
    <!-- Start block -->
    <section class="bg-gray-50 dark:bg-gray-900 p-3 h-screen sm:p-5 antialiased">
                        ...
                        <tbody>
                            <?php foreach ($books as $book) : ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">$<?= htmlspecialchars($book['price']) ?></td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="<?= htmlspecialchars($book['id']) ?>-dropdown-button"
                                            data-dropdown-toggle="<?= htmlspecialchars($book['id']) ?>-dropdown"
                                        ...
                                        <div id="<?= htmlspecialchars($book['id']) ?>-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm" aria-labelledby="<?= htmlspecialchars($book['id']) ?>-dropdown-button">
                                                <li>
                                                    <a href="/api/v1/book/<?= htmlspecialchars($book['id']) ?>"
                                                ...
                                                <li>
                                                    <!-- <form method="post" action="/api/v1/book/delete/<?= $book["id"] ?>"> -->
                                                    <button type="button"
